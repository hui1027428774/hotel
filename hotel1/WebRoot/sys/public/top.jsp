...
<body>
	...
	<div id="Head_1">
		<!-- 标题 -->
		<div id="Head_1_Logo">
			<b style="font-family: '黑体'">酒家信息管理平台</b> <!-- <img border="0" src="style/images/logo.png" /> -->
        </div>
		<!-- 欢迎用户的文字 -->
		...
		<div id="Head_1_FunctionButton">
			...
			<a target="_parent" href="javascript:;">
				<img width="78" height="20" alt="退出系统" src="${pageContext.request.contextPath }/sys/style/images/logout.gif " onclick="cpm();"/>
			</a>
		</div>
	</div>
	<!-- 下部 -->
